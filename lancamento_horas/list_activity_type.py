...
with Browser("phantomjs") as browser:
    ...
    projects = [o for o in browser.find_by_id("novaPanelForm:tipoAtividade").first.find_by_css("option")]
    print("CODIGO \tATIVIDADE")
    [print(o.value.strip() + " \t" + o.text.strip()) for o in projects]
